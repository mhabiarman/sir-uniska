...
$queryy = mysqli_query($conn, "SELECT * FROM tb_surat_kematian WHERE id_surat_kematian = '$id'");
		...
		<?php if($roww['c1'] == 1) { ?>
			<div class="col-md-12">
				<div class="form-group">
					<label for="fc_ktp_pelapor">KTP Pelapor</label>
					<input type="file" class="form-control" name="fc_ktp_pelapor" id="fc_ktp_pelapor" required="" autocomplete="off" placeholder="Upload KTP Pelapor" autofocus="" accept="image/*, application/pdf">
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group">
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#data-form-revisi").submit(function(e) {
			...
			$.ajax({
				type: "POST",
				url: "proses/update-surat-kematian-revisi.php",
				data: data,
				processData: false,
				contentType: false,
				success: function(response) {
					...
					if(dataresponse.status == "1") {
						Swal.fire({
							...
							window.location = "surat-kematian";
						});
					}else {
