...
if(isset($_GET['tipe'])) {
	...
	if($_GET['tipe'] == "perbulan") {
		...
		$query = mysqli_query($conn, "SELECT * FROM tb_pengajuan,tb_pemohon,tb_pengajuanbantu,tb_komoditi WHERE tb_pengajuan.id_pemohon=tb_pemohon.id_pemohon AND tb_pengajuan.id_pengajuan=tb_pengajuanbantu.id_pengajuan AND tb_komoditi.id_komoditi=tb_pengajuanbantu.id_komoditi AND tanggal_pengajuan LIKE '$tahun-$bulan%' ORDER BY tanggal_pengajuan ASC");
		if($_GET['bulan'] == "01") {
			$bulan1='Januari';
...
if(mysqli_num_rows($query) == 0) {
	...
	<th style="width:150px;border: 1px solid #000;">Kode Pengajuan</th>
	<th style="width:150px;border: 1px solid #000;">Nama Pemohon</th>
	<th style="width:150px;border: 1px solid #000;">Nama Perusahaan</th>
	<th style="width:150px;border: 1px solid #000;">Telepon</th>
	<th style="width:150px;border: 1px solid #000;">Pengujian</th>
	<th style="width:150px;border: 1px solid #000;">Komoditi</th>
	<th style="width:150px;border: 1px solid #000;">Jumlah Komoditi</th>
	<th style="width:150px;border: 1px solid #000;">Satuan</th>
	</tr>';
	$no = 1;
	$tot = 0;
