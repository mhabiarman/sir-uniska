...
$pdf= new TCPDF('P','mm',array(210,280));

// set document information
$pdf->SetCreator(PDF_CREATOR);
$pdf->SetAuthor('habi');
$pdf->SetTitle('Laporan Pegawai Penerima
Pengajuan');
...
#########################################################*/
   $cetak = 'Tanggal Di Cetak : '.tglIndonesia(date('d F Y'));
		...
		$query = mysqli_query($conn, "SELECT * FROM tb_pegawai, tb_jabatan WHERE tb_pegawai.fk_jabatan=tb_jabatan.id_jabatan");
...
$tbl2 = '<table border="0">
		...
		<table border="0" style="text-align:center;">
			<tr>
				<td colspan="2" style="text-align:center;"><font size="12em"><b>LAPORAN JUMLAH PEKERJAAN PEGAWAI</b></font></td>
			</tr>
		</table>
		<br><br>
		';
				...
				$tbl2 = $tbl2.'<table border="1px" cellpadding="2" cellspacing="0">
					<tr style="text-align:center;vertical-align:middle;">
									...
									<th style="width:150px;border: 1px solid #000;"><b>No. Telepon</b></th>
									<th style="width:150px;border: 1px solid #000;"><b>Jabatan</b></th>
									<th style="width:150px;border: 1px solid #000;"><b>Jumlah Pekerjaan</b></th>
					</tr>';
					$no = 1;
					while ($tampil = mysqli_fetch_array($query)){
						...
						$tot1 += $row_pegawai['jumlah'];
						
						$tbl2 = $tbl2.'<tr style="text-align:left;">
									<td>'.$no++.'</td>
									<td>'.$tampil['nama_pegawai'].'</td>
									<td>'.$tampil['telepon'].'</td>
									<td>'.$tampil['nama_jabatan'].'</td>
									<td align="right">'.$row_pegawai['jumlah'].'</td>
						</tr>';
					}
					$tbl2 = $tbl2.'
...
ob_end_clean();
$pdf->Output('LAPORAN JUMLAH PEKERJAAN PEGAWAI.pdf', 'I');
}
