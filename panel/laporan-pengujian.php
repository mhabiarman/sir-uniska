				...
				<section class="section">
					<div class="section-header">
						...
						<div class="section-header-breadcrumb">
							...
							<div class="breadcrumb-item">Laporan Hasil Pengujian</div>
						</div>
					</div>
										...
										<div class="row mt-4">
											<div class="col-lg-12 col-md-12">
												<?php if(isset($_GET['submit'])) { ?>
													...
													<?php if(isset($_GET['tipe'])) { ?>
														...
														<?php if($_GET['tipe'] == "pertanggal") { 
															...
															$to = $_GET['to']; 
															?>
															<a href="cetak-pengujian?tipe=pertanggal&from=<?= $from; ?>&to=<?= $to; ?>" target="_blank" class="btn btn-success">
														...
														<?php }else if($_GET['tipe'] == "perbulan") { 
															...
															$tahun = $_GET['tahun'];
															?>
															<a href="cetak-pengujian?tipe=perbulan&bulan=<?= $bulan; ?>&tahun=<?= $tahun; ?>" target="_blank" class="btn btn-success">
																<i class="fas fa-print"></i>
															</a>
														<?php }else if($_GET['tipe'] == "pertahun") { 
															$tahun = $_GET['tahun'];
															?>
															<a href="cetak-pengujian?tipe=pertahun&tahun=<?= $tahun; ?>" target="_blank" class="btn btn-success">
																<i class="fas fa-print"></i>
															</a>
														<?php }else { ?>
															<a href="cetak-pengujian" target="_blank" class="btn btn-success">
																<i class="fas fa-print"></i>
															</a>
														<?php } ?>
												...
												<?php }else { ?>
													...
													<?php } ?>
													<?php if(isset($_GET['submit'])){ ?>
														<a href="laporan-pengujian" class="btn btn-danger">
													...
													<table class="display table table-striped table-hover datatables" id="table-1">
														...
														<tbody>
															...
															if(isset($_GET['submit'])) {
																...
																if(isset($_GET['tipe'])) {
																	...
																	if($_GET['tipe'] == "pertanggal") {
																		...
																		$query = mysqli_query($conn, "SELECT * FROM tb_pengujian,tb_pengajuan, tb_pemohon WHERE tb_pengujian.id_pengajuan=tb_pengajuan.id_pengajuan AND tb_pemohon.id_pemohon=tb_pengajuan.id_pemohon AND DATE(tanggal_pengujian) BETWEEN '$from' AND '$to' ORDER BY tanggal_pengujian ASC");
																	}else if($_GET['tipe'] == "perbulan") {
																		$bulan = $_GET['bulan'];
																		$tahun = $_GET['tahun'];
																		
																		$query = mysqli_query($conn, "SELECT * FROM tb_pengujian,tb_pengajuan, tb_pemohon WHERE tb_pengujian.id_pengajuan=tb_pengajuan.id_pengajuan AND tb_pemohon.id_pemohon=tb_pengajuan.id_pemohon AND DATE(tanggal_pengujian) LIKE '$tahun-$bulan%' ORDER BY tanggal_pengujian ASC");
															...
															while($tampil = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
																...
																<tr>
																	<td><?= $no++;?></td>
																	<td><?php echo tglIndonesia(date('d F Y', strtotime($tampil['tanggal_pengujian'])));?></td>
