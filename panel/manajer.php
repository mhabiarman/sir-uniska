			...
			<div class="main-content">
				<section class="section">
					<div class="section-header">
						<h1>Detail Manajer Teknik</h1>
						<div class="section-header-breadcrumb">
							<div class="breadcrumb-item active"><a href="beranda">Beranda</a></div>
							<div class="breadcrumb-item">Detail Manajer Teknik</div>
						</div>
					</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label for="nip_pengaturan">NIP Manajer Teknik</label>
														<input type="text" name="nip_pengaturan" id="nip_pengaturan"
															class="form-control" required="" autocomplete="off"
															placeholder="NIP Manajer Teknik" autofocus="" minlength="1"
															maxlength="100" value="<?php echo $row['nip_pengaturan'];?>">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label for="nama_pengaturan">Nama Manajer Teknik</label>
														<input type="text" name="nama_pengaturan" id="nama_pengaturan"
															class="form-control" required="" autocomplete="off"
															placeholder="Nama Manajer Teknik" minlength="1"
