...
$pdf->SetAuthor('Jafar');
$pdf->SetTitle('Laporan Komoditi');
$pdf->SetSubject('Komoditi');
...
#########################################################*/
   $cetak = 'Tanggal Di Cetak : '.tglIndonesia(date('d F Y'));
		...
		$query = mysqli_query($conn, "SELECT * FROM tb_komoditi ORDER BY nama_komoditi ASC");
...
$tbl2 = '<table border="0">
		...
		<table border="0" style="text-align:center;">
			<tr>
				<td colspan="2" style="text-align:center;"><font size="12em"><b>LAPORAN PILIHAN KOMODITI</b></font></td>
			</tr>
		</table>
		<br><br>
		';
				...
				$tbl2 = $tbl2.'<table border="1px" cellpadding="2" cellspacing="0">
					<tr style="text-align:center;vertical-align:middle;">
									...
									<th style="width:170px;border: 1px solid #000;"><b>Nama Komoditi</b></th>
					...
					while ($tampil = mysqli_fetch_array($query)){
						...
						$tot1 += $row_komoditi['jumlah'];
						$tot2 += $row_setuju['jumlah'];
						$tot3 += $row_tolak['jumlah'];
						$tbl2 = $tbl2.'<tr style="text-align:center;">
									<td>'.$no++.'</td>
									<td align="left">'.$tampil['nama_komoditi'].'</td>
									<td align="right">'.$row_komoditi['jumlah'].'</td>
									<td align="right">'.$row_setuju['jumlah'].'</td>
									<td align="right">'.$row_tolak['jumlah'].'</td>
						</tr>
						';
					}
					$tbl2 = $tbl2.'
...
ob_end_clean();
$pdf->Output('LAPORAN PILIHAN KOMODITI.pdf', 'I');
}
