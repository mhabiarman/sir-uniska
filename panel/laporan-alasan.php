			...
			<div class="main-content">
				<section class="section">
					<div class="section-header">
						<h1>Laporan Alasan Penolakan Pengajuan</h1>
						<div class="section-header-breadcrumb">
							<div class="breadcrumb-item active"><a href="beranda">Beranda</a></div>
							<div class="breadcrumb-item">Laporan Alasan Penolakan Pengajuan</div>
						</div>
					</div>
										...
										<div class="row mt-4">
											<div class="col-lg-12 col-md-12">
												<?php if(isset($_GET['submit'])) { ?>
													...
													<?php if(isset($_GET['tipe'])) { ?>
														...
														<?php if($_GET['tipe'] == "pertanggal") { 
															...
															$to = $_GET['to']; 
															?>
															<a href="cetak-alasan?tipe=pertanggal&from=<?= $from; ?>&to=<?= $to; ?>" target="_blank" class="btn btn-success">
														...
														<?php }else if($_GET['tipe'] == "perbulan") { 
															...
															$tahun = $_GET['tahun'];
															?>
															<a href="cetak-alasan?tipe=perbulan&bulan=<?= $bulan; ?>&tahun=<?= $tahun; ?>" target="_blank" class="btn btn-success">
																<i class="fas fa-print"></i>
															</a>
														<?php }else if($_GET['tipe'] == "pertahun") { 
															$tahun = $_GET['tahun'];
															?>
															<a href="cetak-alasan?tipe=pertahun&tahun=<?= $tahun; ?>" target="_blank" class="btn btn-success">
																<i class="fas fa-print"></i>
															</a>
														<?php }else { ?>
															<a href="cetak-alasan" target="_blank" class="btn btn-success">
																<i class="fas fa-print"></i>
															</a>
														<?php } ?>
												...
												<?php }else { ?>
													...
													<?php } ?>
													<?php if(isset($_GET['submit'])){ ?>
														<a href="laporan-alasan" class="btn btn-danger">
															...
															if(isset($_GET['submit'])) {
																...
																if(isset($_GET['tipe'])) {
																	...
																	if($_GET['tipe'] == "pertanggal") {
																		...
																		$query = mysqli_query($conn, "SELECT * FROM tb_pengajuan, tb_pemohon WHERE tb_pemohon.id_pemohon=tb_pengajuan.id_pemohon AND status='Tolak' AND DATE(tanggal_pengajuan) BETWEEN '$from' AND '$to' ORDER BY tanggal_pengajuan ASC");
																	}else if($_GET['tipe'] == "perbulan") {
																		$bulan = $_GET['bulan'];
																		$tahun = $_GET['tahun'];
																		
																		$query = mysqli_query($conn, "SELECT * FROM tb_pengajuan, tb_pemohon WHERE tb_pemohon.id_pemohon=tb_pengajuan.id_pemohon AND status='Tolak' AND DATE(tanggal_pengajuan) LIKE '$tahun-$bulan%' ORDER BY tanggal_pengajuan ASC");
